...
;编译生成的安装包名称
!define OUTFILE_NAME "365DesktopSetuponline.exe"
;主程序名称
...
Function MSTY_Btn_Func
  ...
  inetc::post "" /noproxy /silent "http://desktop.xinchuanbo.cn/sadmin/desktopdata.php?oper=set&&mac=$MacAddress&&version=v${PRODUCT_VERSION}&&source=$From&&isOnline=1" $R0 ;"$PLUGINSDIR\reply.htm"
  ...
  ${If} $IsPush == 1
	...
	;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;在线/离线包制作;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "isOnline" 1 ;isOnline 1:在线 0：离线
	;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;在线/离线包制作;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
